...
LOCK TABLES flight READ, schedule READ, route READ, reservation WRITE, passenger READ, ticket READ;
...
LOCK TABLES passenger READ, contact_person WRITE, reservation WRITE, payment WRITE, reservation_on_passenger WRITE, ticket WRITE;
...
LOCK TABLES reservation_on_passenger WRITE, ticket WRITE, payment WRITE, reservation WRITE, passenger WRITE, flight WRITE;
